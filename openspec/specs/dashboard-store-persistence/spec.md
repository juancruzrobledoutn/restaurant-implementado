...
Establish a centralized versioning system and migration framework for Zustand store persistence, enabling safe schema evolution, recovery from breaking changes, and consistency across all persisted menu stores (categories, subcategories, products, allergens, ingredients, recipes).
## Requirements
