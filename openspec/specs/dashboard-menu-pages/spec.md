...
Deliver six fully functional menu CRUD pages for the Dashboard with consistent UI patterns, custom hooks for modal/form state, delete confirmation dialogs, pagination, and WebSocket-driven real-time synchronization via Zustand stores.
