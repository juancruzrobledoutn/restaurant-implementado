...
Dashboard (port 5177), pwaMenu (port 5176), and pwaWaiter (port 5178) SHALL each be scaffolded as Vite 7.2 projects with React 19.2, TypeScript 5.9, Zustand 5, and Tailwind 4.1.
